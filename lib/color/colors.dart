...
class Colours {
  ...
  static final List<Color> themeList = [theme_color_1,theme_color_2,theme_color_3,theme_color_4,theme_color_5];
  ...
  static const Color theme_color_1 = Color(0xff1296db);
  static const Color theme_color_2 = Color(0xffFF4E32);
  static const Color theme_color_3 = Color(0xFFf7418c);
  static const Color theme_color_4 = Color(0xFF00CE3E);
